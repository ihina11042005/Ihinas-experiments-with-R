...
ufo_sightings <- read_csv("D:/files from desktop/R/Ihinas-experiments-with-R/posts/UFO/UFOdata/ufodata.csv") %>% 
...
-   Arizona has a median comparitively higher than the other states
...
### Let's see how daylight and nightime affects the number of sightings
...
### Lastly, let's see the occurance of different shapes during day and night time
